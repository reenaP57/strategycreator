...
extension MILoader {
    ...
    fileprivate static let firstLayer:CAShapeLayer = {
        ...
        firstLayer.strokeColor = ColorBlue.cgColor
    ...
    fileprivate static let secondLayer:CAShapeLayer = {
        ...
        secondLayer.strokeColor = ColorBlue.cgColor
...
extension MILoader {
    ...
    fileprivate func showActivityIndicator() {
        ...
        CTopMostViewController.view.addSubview(MILoader.activityIndicator)
...
extension MILoader {
    ...
    fileprivate func showActivityIndicatorWithMessage(message:String?) {
        ...
        CTopMostViewController.view.addSubview(MILoader.transparentOverlayView)
...
extension MILoader {
    ...
    private func resizeGifLoader() {
        ...
        NSLayoutConstraint(item: MILoader.gifImgView, attribute: .width, relatedBy: .equal, toItem: nil, attribute: .notAnAttribute, multiplier: 1.0, constant: 50.0).isActive = true
        
        NSLayoutConstraint(item: MILoader.gifImgView, attribute: .height, relatedBy: .equal, toItem: nil, attribute: .notAnAttribute, multiplier: 1.0, constant: 50.0).isActive = true
